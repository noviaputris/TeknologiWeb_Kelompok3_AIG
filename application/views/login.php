					...
					<div class="wrap d-md-flex">
						<div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
							<div class="text w-100">
								...
								<a href="<?php echo site_url('Home/daftar')?>" class="btn btn-white btn-outline-white">Daftar</a>
							</div>
			      </div>
			      	...
			      	<div class="d-flex">
			      		<div class="w-100">
							...
							<form action="<?php echo site_url('Login/proseslogin');?>" class="signin-form" method="post">
